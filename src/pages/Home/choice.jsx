export default function choice () {
  const target = [
    ...
    <div
      className='choice__item cursor-pointer mx-[20px] max-w-[340px] border-[4px] rounded-[8px] p-[20px] flex flex-col items-center justify-center opacity-80 group hover:opacity-100 transition-all'
